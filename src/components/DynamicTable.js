...
class DynamicTable extends React.Component {
  ...
  onKeyPress =  (e, index, totalLength, fieldInfoObject) => {
    ...
    console.log("DYNA",this.props.pageState);
    
    // let w1 = 0, w2 = 0;
    
    if (fieldInfoObject.name == "weight" && keyString == "Enter") {
      
      // for mulitple of nearnest 5 in c_wgt
      // let amt = this.props.pageState.item_in[0].weight;
      // while(amt%5!==0) amt++
      // this.props.pageState.item_in[0].c_wgt = amt;
      
      
      // w1 += parseInt(this.props.pageState.item_in[0].weight);
      // this.props.pageState.actual_weight = w1;

      // w2 += this.props.pageState.item_in[0].c_wgt;
      // this.props.pageState.charge_wgt = w2;
