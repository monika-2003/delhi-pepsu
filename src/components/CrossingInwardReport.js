...
function CrossingInWardReport({ sessionObject }) {
    ...
    const handlePrint = async () => {
        ...
        let url = SERVER_URL + "/crossing_inward/report_print/";
    ...
    return (
        <div className="page-marfatiya-wise">
            <div className="mr-form-container">
                ...
                <div className="form-header">Crossing Inward Report</div>
...
export default CrossingInWardReport;
