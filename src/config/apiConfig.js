...
const biltyApiConfig = {
  getBilty: {
    responseSchema: {
      ...
      trip_no: "same",
      total_amount: "same",
      // total_amount: "new_total_amount", // what for same ?
      transporter_id: "same",
...
const challanApiConfig = {
  getChallan: {
    responseSchema: {
      ...
      fyear: "fYear_get",
      transaction_id: "same",
      is_crossing_challan: "same",
      broker_name: "same",
      less_wgt_by_pkg: "same",
      total_less_wgt: "same",
    },
...
const tripApiConfig = {
  getTrip: {
    responseSchema: {
      ...
      actual_weight:"same",
      our_weight:"same",
      crossing_weight:"same",
      rate:"same",
      truck_weight:"same",
      truck_hire:"same",
      labour:"same",
      labour_calculation:"same",
      other_charge:"same",
      cash_received_by_driver:"same",
      gross_amount:"same",
      tds_rate:"same",
      advance_bhada:"same",
      rebate:"same",
      rebate_calculation:"same",
      crossing:"same",
      crossing_calculation:"same",
      total_to_pay:"same",
      to_be_billed:"same",
      total_to_paid:"same",
      pay_to_driver:"same",
...
const crossingOutApiConfig = {
  ...
  getCrossingOut: {
    responseSchema: {
      ...
      fyear: "fYear_get",
      consider_cwgt: "same",
      crossing_total_weight:"same",
      crossing_less_wgt_by_pkg: "same",
      crossing_total_less_wgt: "same",
      crossing_bulky_goods_package: "same",
      crossing_bulky_goods_rate: "same",
      crossing_bulky_goods_amount: "same",
      crossing_hire: "same",
