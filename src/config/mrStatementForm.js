...
const mrStatementTableHeader = [
  ...
  // { label: "Payment Type", className: "text-center table-header" },
  { label: "Mr Date", className: "text-center table-header" },
  { label: "To Pay Amount", className: "text-center table-header" },
  { label: "LC Charge", className: "text-center table-header" },
  { label: "DC Charge", className: "text-center table-header" },
