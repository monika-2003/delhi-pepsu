...
const ChallanInwardDataObject = {
  ...
  fyearList:[],
  suffix_options: [],
  unloading_bilty_table:[],
  added_unloading_bilty_table:[],
  prev_unloading_no:undefined,
  bilty_id:"",
  id:""
};
...
const challanInwardTableHeader = [
  { label: "S. No.", className: "text-center table-header" },
  { label: "Bilty No.", className: "text-center table-header" },
  { label: "Lot Size", className: "text-center table-header" },
  { label: "Short", className: "text-center table-header" },
  { label: "Excess", className: "text-center table-header" },
  { label: "Remark", className: "text-center table-header" },
  { label: "Receive", className: "text-center table-header" },
];
...
//   id: yup.number({"id": "Bilty should be string"}),
// }
export {
  groupNames,
